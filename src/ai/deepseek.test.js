...

{
  ...
  assertEqual(capturedUrl, "https://api.deepseek.com/v1/chat/completions", "URL 正确");
  afterEach();
}
...
console.log("\n=== 测试 20：content 为空 → empty_content ===\n");
...
console.log("\n=== 测试 21：content 为 null → empty_content ===\n");
...
console.log("\n=== 测试 23：API Key 缺失时 provider 仍可创建（不抛异常）===\n");
...
console.log("\n=== 测试 26：reasoning_content 不被当作最终 content 返回 ===\n");
